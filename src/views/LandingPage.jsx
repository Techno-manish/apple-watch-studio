  ...
  return (
    ...
    >
      <div className="text-center space-y-8">
        ...
        >
          <h1 className="text-2xl font-semibold sm:font-normal sm:text-xl landingPageT1">
            Apple Watch Studio
          </h1>
        ...
        >
          <Button
            size="lg"
            className="bg-[#0071e3] hover:bg-[#0071e3] px-4 sm:px-6 rounded-full text-white font-proDisplayRegular text-[14px] sm:text-[18px]"
